...
import '../../FireBase/authentication/auth_services/authen_service.dart';
            ...
            Stack(
              children: [
                ...
                Center(
                  ...
                  'assets/78126-secure-login.json',
                  height: height / 2.5,
                  fit: BoxFit.fitWidth,
                )),
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: height / 3, left: 15, right: 15),
                  child: Container(
                    height: height * 3 / 4,
                    color: c4,
                    //color: Colors.white,
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (id == '-2') //key not found
      {
        ...
        } else //Everything is correct
        {
          ...
          await Prefs.setString(
              'UserEmail',
              model
                  .email!); //so we have in prefs file : loginState,email and data(user Info) so i can get what i want from this info
      ...
      if (await ConnectivityService.checkInternetConnectivity()) {
        ...
        Loader.showLoadingScreen(
            context, _keyLoader); // key : to check current state
        ...
        if (result == "NO USER FOUND") {
          ...
          log("Log in is done");
          Navigator.of(context)
              .pushReplacementNamed(homePage, arguments: result);
        }
      } else {
