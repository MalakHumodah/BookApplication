...
class Items {
  ...
  Items.fromJson2(Map<String, dynamic> json) {
    kind = json['kind'];
    id = json['id'];
    etag = json['etag'];
    selfLink = json['selfLink'];
...
class VolumeInfo {
  ...
  factory VolumeInfo.fromJson(Map<String, dynamic> json) {
    return VolumeInfo(
      title: json['title'],
      authors: List<String>.from(json['authors'].cast<String>()),
      ...
      categories: List<String>.from(json['categories'].cast<String>()),
  ...
  VolumeInfo.fromJson2(Map<String, dynamic> json) {
    title = json['title'];
...
class IndustryIdentifiers {
  ...
  factory IndustryIdentifiers.fromJson(Map<String, dynamic> json) {
    return IndustryIdentifiers(
        type: json['type'], identifier: json['identifier']);
  }

  IndustryIdentifiers.fromJson2(Map<String, dynamic> json) {
    type = json['type'];
...
class ReadingModes {
  ...
  ReadingModes.fromJson2(Map<String, dynamic> json) {
    text = json['text'];
    image = json['image'];
  }
...
class PanelizationSummary {
  ...
  PanelizationSummary.fromJson2(Map<String, dynamic> json) {
    containsEpubBubbles = json['containsEpubBubbles'];
    containsImageBubbles = json['containsImageBubbles'];
  }
...
class ImageLinks {
  ...
  ImageLinks.fromJson2(Map<String, dynamic> json) {
  ...
  factory SaleInfo.fromJson(Map<String, dynamic> json) {
    return SaleInfo(
      ...
      offers: (json['offers'] != null)
          ? List<Offers>.from(json['offers'].map((v) => Offers.fromJson(v)))
          : <Offers>[],
    );
  }

  SaleInfo.fromJson2(Map<String, dynamic> json) {
    country = json['country'];
    saleability = json['saleability'];
    isEbook = json['isEbook'];
    listPrice = json['listPrice'] != null
...
class ListPrice {
  ...
  factory ListPrice.fromJson(Map<String, dynamic> json) {
    return ListPrice(
        amount: json['amount'], currencyCode: json['currencyCode']);
  }

  ListPrice.fromJson2(Map<String, dynamic> json) {
    amount = json['amount'];
...
class Offers {
  ...
  Offers.fromJson2(Map<String, dynamic> json) {
    finskyOfferType = json['finskyOfferType'];
    listPrice = json['listPrice'] != null
        ? ListPrice.fromJson(json['listPrice'])
        : null;
...
class AccessInfo {
  ...
  AccessInfo.fromJson2(Map<String, dynamic> json) {
    country = json['country'];
    viewability = json['viewability'];
    embeddable = json['embeddable'];
    publicDomain = json['publicDomain'];
...
class Epub {
  ...
  factory Epub.fromJson(Map<String, dynamic> json) {
    return Epub(
        isAvailable: json['isAvailable'], acsTokenLink: json['acsTokenLink']);
  }

  Epub.fromJson2(Map<String, dynamic> json) {
...
class SearchInfo {
  ...
  SearchInfo.fromJson2(Map<String, dynamic> json) {
...
/*class BookList {
  ...
  factory BookList.fromJson(List<dynamic> data) {
    List<BookModel> list = [];

    list = data.map((item) => BookModel.fromJson(item)).toList();

    return BookList(books:list );
  }
}
*/